...
class TestProxyKmipClientIntegration(testtools.TestCase):
    ...
    def test_add_delete_attribute(self):
        """
        Test that the ProxyKmipClient can add and delete an attribute.
        """
        key_id = self.client.create(
            enums.CryptographicAlgorithm.IDEA,
            128,
        ...
        self.assertEqual(9, len(result_attributes))

        response_id, response_attr = self.client.add_attribute(
            unique_identifier=key_id,
        ...
        self.assertEqual(key_id, response_id)
        self.assertEqual("Sensitive", response_attr.attribute_name.value)
        self.assertEqual(0, response_attr.attribute_index.value)
        self.assertEqual(
            True,
            response_attr.attribute_value.name_value.value
        ...
        #
        # # Get the "Object Group" attribute for the key to verify it was added.
        # result_id, result_attributes = self.client.get_attributes(
        #     uid=key_id,
        #     attribute_names=["Object Group"]
        # )
        # self.assertEqual(1, len(result_attributes))
        # self.assertEqual("Object Group", result_attributes[0].attribute_name.value)
        # self.assertEqual(
        #     "Test",
        #     result_attributes[0].attribute_value.name_value.value
        # )
